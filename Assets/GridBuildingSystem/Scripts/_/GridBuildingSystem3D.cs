...
public class GridBuildingSystem3D : MonoBehaviour
{
    ...
    [SerializeField] private List<BuildItemSO> placedObjectTypeSOList = null;
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0) && placedObjectTypeSO != null)
        {
            ...
            if (canBuild)
            {
                ...
                BuildItemDone placedObject = BuildItemDone.Create(placedObjectWorldPosition, placedObjectOrigin, dir, placedObjectTypeSO);
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            {
                // Valid Grid Position
                BuildItemDone placedObject = grid.GetGridObject(mousePosition).GetPlacedObject();
    ...
    public BuildItemSO GetPlacedObjectTypeSO()
    {
